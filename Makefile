...
.PHONY: help validate-workflows validate-yaml lint-workflows validate-opentofu clean install-tools summary all
...
help:
	...
	@echo "  validate-opentofu   - List workflows with OpenTofu support enabled"
